<?php
   ...
   $stok ="";
    ...
    if($id != ""){
        $sql ="update buku set judul='$judul', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$thn_terbit', stok='$stok' where id='$id'";
    }else{
        $sql ="insert into buku (id,img,judul,penulis,penerbit,tahun_terbit,stok) values('','$foto_name','$judul','$penulis','$penerbit','$thn_terbit',' $stok')";
    }
    ...
    <body>
        ...
        if($id!=""){
            ...
            echo'<label for="inputPassword5" class="form-label">cover</label>
            <input type="file" name="foto" value="<?php echo $img; ?>" id="formFile" class="form-control" aria-describedby="passwordHelpBlock">';
        }
        ?>
        ...
        <label for="inputPassword5" class="form-label">stok</label>
        <input type="int" name="stok" value="<?php echo $stok;?>" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock">
